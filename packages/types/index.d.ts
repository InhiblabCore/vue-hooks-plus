...
declare class Fetch<TData, TParams extends unknown[] = any> {
    ...
    options: Partial<UseRequestOptions<TData, TParams, any> & UseRequestOptionsWithFormatResult<TData, TParams, any, any>>;
...
declare type RequestHook<TData = any, TParams extends any[] = any[]> = (service: UseRequestService<TData, TParams>, options: UseRequestOptions<TData, TParams, any>, plugins: UseRequestPlugin<TData, TParams>[]) => useRequestResult<TData, TParams>;

declare type ResizeObserverCallback_2 = (entries: ReadonlyArray<ResizeObserverEntry>, ob: ResizeObserver) => void;
...
export declare function useRequest<TData, TParams extends unknown[] = unknown[], PluginsOptions extends UseRequestPlugin<TData, TParams>[] = UseRequestPlugin<TData, TParams>[], SR = any>(service: UseRequestService<SR, TParams>, options?: UseRequestOptionsWithFormatResult<TData, TParams, PluginsOptions extends (infer P)[] ? P extends UseRequestPlugin<TData, TParams, infer R> ? R : never : never, SR>, plugins?: PluginsOptions): useRequestResult<TData, TParams>;
...
declare type UseRequestBasicOptions<TData, TParams extends unknown[]> = {
    /**
     * Init data.
     */
    initialData?: TData;
...
declare type UseRequestMiddleware<TData, TParams extends any[]> = (useRequestNext: RequestHook<TData, TParams>) => RequestHook<TData, TParams>;

declare type UseRequestOptions<TData, TParams extends any[] = any[], TPlugin = any> = UseRequestBasicOptions<TData, TParams> & {
    pluginOptions?: TPlugin;
};

declare type UseRequestOptionsWithFormatResult<TData, TParams extends any[] = any[], TPlugin = any, SR = any> = UseRequestOptions<TData, TParams, TPlugin> & {
...
export declare function useResizeObserver(target: BasicTarget | BasicTarget[], callback: ResizeObserverCallback_2, options?: UseResizeObserverOptions): UseResizeObserverReturnType;

declare interface UseResizeObserverOptions {
    /**
...
declare interface UseResizeObserverReturnType {
